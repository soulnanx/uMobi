...
public class CropImageUtil {
    ...
    public static void doCrop(final Fragment fragment, final Uri imageCaptureUri, int sizeX, int sizeY) {
        ...
        if (size == 0) {
            ...
            new TinyDB(fragment.getActivity()).putString(PATH_IMAGE_CROP, pathFile);
